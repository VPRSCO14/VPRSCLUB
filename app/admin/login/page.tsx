  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-vprs-white px-6">
      <form
        ...
        className="w-full max-w-sm border border-vprs-black/10 rounded-vprs p-8"
      >
        ...
        {error && (
          <p className="text-sm font-body mb-4" style={{ color: "#8C2F2F" }}>{error}</p>
        )}
